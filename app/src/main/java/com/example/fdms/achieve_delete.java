...
public class achieve_delete extends AppCompatActivity {
    EditText e1;
    myDbAdapter helper;
    String mid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_achieve_delete);
        e1 = (EditText) findViewById(R.id.editText1);
        global g=global.getInstance();
        String s=g.getData();
        e1.setText(""+s);
        e1.setKeyListener(null);
        getSupportActionBar().setTitle("Achievement Details Delete");
    ...
    public void delete(View view) {
        ...
        if (mid.isEmpty()) {
            ...
            final SweetAlertDialog pDialog = new SweetAlertDialog(achieve_delete.this, SweetAlertDialog.WARNING_TYPE);
            ...
            pDialog.setCancelButton("Cancel", new SweetAlertDialog.OnSweetClickListener() {
                ...
                public void onClick(SweetAlertDialog sweetAlertDialog) {
                    Intent i1 = new Intent(achieve_delete.this, MainActivity.class);
                    startActivity(i1);
                    finish();
                }
            });
            pDialog.setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                @Override
                public void onClick(SweetAlertDialog sweetAlertDialog) {
                    int count = helper.ach_delete(mid);
                    if (count <= 0) {
                        //Message.message(getApplicationContext(), "Member Account Not Exist");
                        SweetAlertDialog pDialog = new SweetAlertDialog(achieve_delete.this, SweetAlertDialog.ERROR_TYPE);
                        ...
                        SweetAlertDialog pDialog = new SweetAlertDialog(achieve_delete.this, SweetAlertDialog.SUCCESS_TYPE);
