...
public class assets_delete extends AppCompatActivity {
    EditText e1;
    myDbAdapter helper;
    String  mid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assets_delete);
        ...
        getSupportActionBar().setTitle("Assets Details Delete");
    }
    ...
    public void delete(View view) {
        ...
        if (mid.isEmpty()) {
            ...
            final SweetAlertDialog pDialog = new SweetAlertDialog(assets_delete.this, SweetAlertDialog.WARNING_TYPE);
            ...
            pDialog.setCancelButton("Cancel", new SweetAlertDialog.OnSweetClickListener() {
                ...
                public void onClick(SweetAlertDialog sweetAlertDialog) {
                    Intent i1 = new Intent(assets_delete.this, MainActivity.class);
                    startActivity(i1);
                    finish();
                }
            });
            pDialog.setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                @Override
                public void onClick(SweetAlertDialog sweetAlertDialog) {
                    int count = helper.adelete(mid);
                    if (count <= 0) {
                        //Message.message(getApplicationContext(), "Member Account Not Exist");
                        SweetAlertDialog pDialog = new SweetAlertDialog(assets_delete.this, SweetAlertDialog.ERROR_TYPE);
                        ...
                        SweetAlertDialog pDialog = new SweetAlertDialog(assets_delete.this, SweetAlertDialog.SUCCESS_TYPE);
